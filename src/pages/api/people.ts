...
const getPersonListDetails = (person: PersonDetailsInfo) => pick(person, ['id', 'name', 'age', 'lastUpdated'])

export const GET: APIRoute = () => {
	const rawList = parse<PersonDetailsInfo[]>(fs.readFileSync(apiListPath, "utf8"));
